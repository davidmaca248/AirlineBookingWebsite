...
export default function PilotPage() {
  return (
    <div className="admin-container">
      <h1>Pilots</h1>
      <Link to="/pilotList">
        <button className="btn btn-transparent btn-exLar">All Pilots</button>
      </Link>
      <Link to="/pilotAdd">
        <button className="btn btn-transparent btn-exLar">Add Pilot</button>
      </Link>
    </div>
  );
}
...
export function List() {
  ...
  return (
    <div className="list">
      ...
      {list.map((val, key) => {
        return (
          <div key={val.pilot_id} className="listElem">
            <div>
...
export function Add() {
  ...
  return (
    <div className="admin-container">
      ...
      />
      <button className="btn btn-opaque btn-med" onClick={addPilot}>
        Add Pilot
      </button>
    </div>
  );
